...
/*
 * Make the internal ACL structure from sys/acl.h available.
 *
 * It's included by target_os_proto.h generated by the makesyscalls script that
 * is usually used to generate kernel headers that don't require _ACL_PRIVATE
 * to use the ACL structure.
 */
#ifndef _ACL_PRIVATE
#define _ACL_PRIVATE
#endif
