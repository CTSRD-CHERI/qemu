...
TCGv_cap_checked_ptr clean_data_tbi_and_cheri(DisasContext *s, TCGv_i64 addr, bool is_load, bool is_store, int size, int base_reg,
...
TCGv_cap_checked_ptr gen_mte_and_cheri_check1(DisasContext *s, TCGv_i64 addr, bool is_read, bool is_write,
                                              bool tag_checked, int log2_size, int base_reg,
                                              bool alternate_base, bool ddc_base);
